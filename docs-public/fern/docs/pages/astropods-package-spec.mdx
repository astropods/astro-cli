...
<Versions>
<Version version="v1.6 (Draft) - 2026-05-12" default>
...
| v1.4    | 2026-04-08 | Removed `dev.overrides.playgroundImage`; playground UI is now bundled into the messaging container and served automatically when the `web` adapter is enabled. |
