...
| Field       | Type            | Required    | Description                                                                             |
| ----------- | --------------- | ----------- | --------------------------------------------------------------------------------------- |
| `provider`  | string          | Conditional | Cloud model provider name (e.g. `anthropic`, `openai`) or a custom provider.            |
| `models`    | string[]        | OPTIONAL    | Model identifiers to make available.                                                    |
