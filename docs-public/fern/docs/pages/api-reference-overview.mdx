...
The reference documentation in the **Endpoints** section is generated from the [Astro AI OpenAPI specification](https://github.com/astromode-ai/astro-docs/blob/main/fern/apis/astro-api/openapi.yaml). You can use it to generate clients or integrate with the API programmatically.
