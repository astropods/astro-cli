...
When you're ready to publish your agent to the Astro AI registry, see [Publish to registry](/publish-to-registry). Pushing requires an account and `ast login`.
