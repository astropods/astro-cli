...
- **Astropods Spec** — Declarative YAML format (<code>astropods.yml</code>) that describes an agent's topology: container, models, knowledge stores, tools, and ingestion. See [Astropods Spec](/understanding-astropods-spec).
