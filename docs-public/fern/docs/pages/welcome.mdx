...
<Steps>
  <Step title="Install the CLI">
    [Install the CLI](/install-cli) for your platform.
  </Step>
  <Step title="Run an agent locally">
    [Your first project](/get-started): create an agent harness, configure it, and run it locally.
  </Step>
  <Step title="Publish a blueprint">
    [Your first blueprint](/blueprints): push your project to the registry.
  </Step>
  <Step title="Deploy a live agent">
    [Deploy your first agent](/deploy-agent): run a blueprint as a hosted agent.
  </Step>
</Steps>
