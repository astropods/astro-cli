...
For web-chat file input and agent-produced downloads, see [Files in chat](./files-in-chat).
...
The chat also supports user uploads and agent-produced download files. See [Files in chat](./files-in-chat) for the filesystem and message contract.
