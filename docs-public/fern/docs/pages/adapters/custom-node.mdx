...
Enable the web adapter in `astropods.yml` (`dev.interfaces.messaging.adapters: [web]`) and run your agent under `ast dev`. Open the chat at `http://localhost:3100` and send a message. You should see the reply `Hello, <your message>!`.
