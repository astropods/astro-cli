...
Initiates an OAuth 2.0 Device Authorization Flow. After completing the browser flow, credentials are stored in the system keyring or `~/.ast/credentials.json`. See [Authentication](/authentication) for details.
