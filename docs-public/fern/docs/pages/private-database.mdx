---
title: Allowlist Astro's egress IPs
subtitle: Let agents reach a database behind your firewall over the public network
slug: ip-allowlisting
---

Agents run in Astro's managed cloud. If your database sits behind a firewall but is reachable over the public network, you can let agents through by allowlisting Astro's outbound IPs — no AWS account or infrastructure changes needed on your side.
