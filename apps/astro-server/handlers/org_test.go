...
func TestListMembers_CrossAccount_Denied(t *testing.T) {
	...
	mock.ExpectQuery("SELECT .+ FROM accounts a LEFT JOIN account_organizations ao").
		...
		WillReturnRows(sqlmock.NewRows([]string{"id", "name", "type", "workos_org_id", "deleted_at", "created_at", "updated_at", "display_name", "avatar_colors", "account_number", "bio", "location", "email", "local_timezone", "pronouns", "website", "social_links"}).
			AddRow("acct-b", "org-b", "organization", "org_b_wos", nil, time.Now(), time.Now(), "", nil, nil, nil, nil, nil, nil, nil, nil, nil))
...
var orgAccountCols = []string{"id", "name", "type", "workos_org_id", "deleted_at", "created_at", "updated_at", "display_name", "avatar_colors", "account_number", "bio", "location", "email", "local_timezone", "pronouns", "website", "social_links"}
