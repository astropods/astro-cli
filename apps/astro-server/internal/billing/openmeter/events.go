...
// current timestamp. It is the provider-agnostic replacement for the former
// NewCloudEvent constructor on the emit path; the OpenMeter Provider adapter
// maps these back to the CloudEvent wire format.
