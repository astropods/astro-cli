...
// OIDC issuer reconciliation tests deleted along with the reconciler. Under
// the tenant-router model OIDC is enforced at the front-door ALB listener
// rule managed in astro-infra; nothing per-Ingress to reconcile.
