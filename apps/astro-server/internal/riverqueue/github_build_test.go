...
func TestNewGitHubBuildWorker_WiresOMClientAndDB(t *testing.T) {
	...
	w := NewGitHubBuildWorker(nil, nil, nil, nil, nil, nil, logger.New("error", "json"), omClient, db, nil, nil)
...
func TestNewGitHubBuildWorker_NilOMClient(t *testing.T) {
	...
	w := NewGitHubBuildWorker(nil, nil, nil, nil, nil, nil, logger.New("error", "json"), nil, db, nil, nil)
	if w.omClient != nil {
...
func TestEmitFunctions_NilClientIsNoOp(t *testing.T) {
	...
	w := NewGitHubBuildWorker(nil, nil, nil, nil, nil, nil, log, nil, db, nil, nil)
...
func TestEmitFunctions_SendsBothEventsWithCorrectSubject(t *testing.T) {
	...
	log := logger.New("error", "json")
	w := NewGitHubBuildWorker(nil, nil, nil, nil, nil, nil, log, omClient, db, nil, nil)
