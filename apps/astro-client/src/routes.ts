...
export default [
  layout("components/Layout.tsx", [
    ...
    route(":account/settings", "pages/AccountSettings.tsx"),
    route(":account/members/invite", "pages/AccountMembersInvite.tsx"),
    route(":account/members", "pages/AccountMembers.tsx"),
