    ...
    <div className="flex flex-col gap-6 p-4">
      ...
      <div>
        ...
        <div className="flex items-center gap-1.5">
          <a className="flex items-center gap-1.5 rounded-[4px] border border-stone-300/60 bg-transparent px-2 py-1 font-mono text-[11px] leading-none uppercase tracking-[0.14em] text-muted-foreground">
