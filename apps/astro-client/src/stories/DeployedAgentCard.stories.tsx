...
const GRID_CARDS: DeployedAgentCardProps[] = [
  { account: "chrisjpatty", name: "chrisbot", displayName: "Chrisbot", deploymentId: "dep-01HX5K2P9R", avatarUrl: chrisbotAvatar, avatarColors: chrisbotColors, requestSeries: seededSeries(1, 7, 15, 40), tokenSeries: seededSeries(101, 7, 2000, 8000), launchUrl: "https://chrisbot.example.com" },
  ...
  { account: "chrisjpatty", name: "grappling-hook", displayName: "Grappling Hook", deploymentId: "dep-01HX9N5R3A", avatarUrl: grapplingHookAvatar, avatarColors: grapplingHookColors, requestSeries: seededSeries(3, 7, 30, 80), tokenSeries: seededSeries(103, 7, 5000, 12000), launchUrl: "https://grappling.example.com" },
  ...
  { account: "chrisjpatty", name: "memory-box", displayName: "Memory Box", deploymentId: "dep-01HXE9V8W6", avatarUrl: memoryBoxAvatar, avatarColors: memoryBoxColors, requestSeries: seededSeries(6, 7, 80, 60), tokenSeries: seededSeries(106, 7, 12000, 20000), launchUrl: "https://memory-box.example.com" },
  { account: "chrisjpatty", name: "slack-bot", displayName: "Slack Bot", deploymentId: "dep-01HXFAW9X7", avatarUrl: slackBotAvatar, avatarColors: slackBotColors, requestSeries: [0, 0, 0, 0, 0, 0, 14], tokenSeries: [0, 0, 0, 0, 0, 0, 3200], launchUrl: "https://slack-bot.example.com" },
