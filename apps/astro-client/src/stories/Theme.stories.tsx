...
const semanticTokens = [
  {
    ...
    tokens: [
      ...
      { name: "primary-foreground", bg: "bg-primary-foreground", text: "text-primary", desc: "Text on primary", light: "#fff", dark: "#fff" },
  ...
  },
  {
    ...
    tokens: [
      ...
      { name: "surface", bg: "bg-surface", text: "text-foreground", desc: "Elevated surface", light: "slate-100", dark: "slate-900" },
      { name: "popover", bg: "bg-popover", text: "text-foreground", desc: "Popover / dropdown", light: "slate-25", dark: "slate-800" },
      ...
      { name: "accent", bg: "bg-accent", text: "text-accent-foreground", desc: "Accent / hover fill", light: "slate-200", dark: "slate-800" },
      { name: "muted", bg: "bg-muted", text: "text-muted-foreground", desc: "Muted background", light: "slate-200", dark: "slate-800" },
    ],
  },
  {
    group: "Border & Input",
    ...
    tokens: [
      ...
      { name: "input-background", bg: "bg-[var(--input-background)]", text: "text-foreground", desc: "Input fill", light: "slate-25", dark: "slate-100 @ 5%" },
