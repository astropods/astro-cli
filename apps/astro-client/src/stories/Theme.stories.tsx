...
const semanticTokens = [
  ...
  },
  {
    ...
    tokens: [
      ...
      { name: "surface", bg: "bg-surface", text: "text-foreground", desc: "Application shell", light: "slate-100", dark: "950/900 mix 20%" },
      { name: "card", bg: "bg-card", text: "text-foreground", desc: "Card / panel", light: "white", dark: "950/900 mix 40%" },
      { name: "popover", bg: "bg-popover", text: "text-foreground", desc: "Popover / dropdown", light: "white", dark: "950/900 mix 65%" },
      ...
      { name: "muted", bg: "bg-muted", text: "text-muted-foreground", desc: "Muted background", light: "slate-200", dark: "card" },
    ],
  },
  {
    group: "Border & Input",
