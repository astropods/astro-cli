          ...
          <Link to={`/${slug}`} className="flex min-w-0 flex-1 items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                ...
                {isDraft
                  ? <InlineBadge shape="pill" variant="soft" className="normal-case" style={{ color: "var(--color-yellow-700)", background: "color-mix(in oklch, var(--color-yellow-700) 12%, transparent)" }}>Finish set up</InlineBadge>
