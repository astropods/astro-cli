...
export function FindBlueprintsWizard({ onClose }: WizardProps) {
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex gap-2.5 max-w-[90%] self-start">
          ...
          <div className="border border-stone-300 p-3 text-sm">
            <p>
              Hi! I'm here to help you find the perfect blueprints for your needs.
          ...
          <div className="flex gap-2.5 max-w-[90%] self-start">
            ...
            <div className="border border-stone-300 p-3 text-sm">
              ...
              <div className="flex flex-col gap-2.5 mt-2">
                {recommendations.map((blueprint) => (
                  <div key={blueprint.slug} className="border border-stone-300 p-3">
                    <h4 className="font-semibold text-sm mb-1.5">{blueprint.name}</h4>
                    ...
                    <p className="text-stone-600 text-sm mb-2">{blueprint.description}</p>
                    <Link
                      to={`/${blueprint.slug}`}
