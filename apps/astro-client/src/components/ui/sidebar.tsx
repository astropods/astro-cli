    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-stone-50 has-data-[variant=inset]:dark:bg-stone-950 flex min-h-svh md:h-svh md:min-h-0 w-full",
            className
          )}
          {...props}
        >
    ...
    >
      ...
      >
        <div
          ...
          className="bg-background group-data-[variant=floating]:border-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm group-data-[variant=inset]:border-r group-data-[variant=inset]:border-white group-data-[variant=inset]:dark:border-black"
        >
          {children}
        </div>
      </div>
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[variant=inset]:m-6 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:border md:peer-data-[variant=inset]:border-border md:peer-data-[variant=inset]:overflow-hidden md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-4",
        className
      )}
      {...props}
    />
...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      className={cn("bg-border mx-3 w-auto", className)}
      {...props}
    />
  )
}
