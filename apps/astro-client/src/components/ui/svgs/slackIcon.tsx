...
// Monochrome Slack mark: the brand glyph paths recolored to currentColor so it
// follows the surrounding text color, matching the other monochrome brand
// glyphs (discordIcon, githubIcon, xIcon). Use `slack.tsx` for the full-color logo.
export function SlackIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 2447.6 2452.5" fill="currentColor" aria-hidden="true" {...props}>
