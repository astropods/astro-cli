...
const buttonVariants = cva(
  "inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-[calc(var(--radius-sm)+2px)] text-sm transition-all disabled:pointer-events-none disabled:opacity-35 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground font-semibold tracking-[-0.01em] hover:bg-indigo-800 active:bg-indigo-900 dark:hover:bg-indigo-700 dark:active:bg-indigo-800",
        destructive:
        ...
        outline:
          "border border-border bg-transparent text-foreground font-normal px-3.5 hover:bg-accent hover:text-accent-foreground active:bg-accent data-[active]:bg-accent data-[active]:text-accent-foreground dark:border-input",
        ghost:
          "text-foreground hover:bg-slate-200 hover:text-accent-foreground active:bg-slate-300 dark:hover:bg-slate-800 dark:active:bg-slate-900",
        link: "text-foreground-accent underline decoration-foreground-accent/40 underline-offset-4 hover:decoration-foreground-accent",
      },
      size: {
