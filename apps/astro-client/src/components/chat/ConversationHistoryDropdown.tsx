              ...
              return (
                ...
                >
                  <DropdownMenuItem
                    ...
                    className="w-0 min-w-0 flex-1 cursor-pointer flex-col items-start gap-0 rounded-sm px-2.5 py-2 text-inherit focus:bg-transparent focus:text-inherit data-[highlighted]:bg-transparent"
                  >
                    <span className="block w-full truncate text-body-sm font-medium">
                      {session.title || DEFAULT_CONVERSATION_TITLE}
                    </span>
                    <span
