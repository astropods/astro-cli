...
const proseClasses = [
  ...
  "prose-h1:text-[22px] prose-h1:mt-8 prose-h1:mb-3 prose-h1:pb-2 prose-h1:border-b prose-h1:border-stone-400 dark:prose-h1:border-border",
  "prose-h2:text-[17px] prose-h2:mt-7 prose-h2:mb-2.5 prose-h2:pb-2 prose-h2:border-b prose-h2:border-stone-400 dark:prose-h2:border-border",
  ...
  // code blocks
  "prose-pre:my-3.5 prose-pre:rounded-md prose-pre:bg-teal-900 prose-pre:text-[#b8ccc8] prose-pre:leading-[1.8] [&_pre_code]:text-[12.5px]",
  // inline code
  "[&_:not(pre)>code]:rounded [&_:not(pre)>code]:bg-stone-300 [&_:not(pre)>code]:border [&_:not(pre)>code]:border-stone-400",
...
const markdownComponents = {
  input: ({ node: _, ...props }: React.ComponentPropsWithoutRef<"input"> & { node?: unknown }) => (
    <input {...props} disabled={false} readOnly />
  ),
};
